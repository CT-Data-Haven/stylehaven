...
write_plot(plots$govt_trend, filename = "government_trend", add_logo = FALSE, 
...
purrr::iwalk(plots, function(pl, id) {
  ps <- plot_params[[id]]
  write_plot(pl, filename = id, add_logo = FALSE,
             dir = out_dir, width = ps$w, height = ps$h, dpi = 150, verbose = FALSE)
})
