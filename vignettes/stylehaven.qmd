...
This is a good time to check the contrast between the colors in this palette and the dark and light colors I might use for labels. `contrast_colors()` helps make sure your background and text colors have enough contrast to be legible for readers with low vision.
...
ggplot(hartford_age, aes(x = value, y = forcats::fct_rev(sex), color = name)) +
    ...
    ggrepel::geom_text_repel(aes(label = value),
        ...
        seed = 1, direction = "x", nudge_y = 0.25,
